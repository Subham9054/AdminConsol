...
namespace CodeGen.Model.User
{
    ...
    public class ButtonTab1
    {
        //BUTTONID,BUTTONNAME,VCHFILENAME,INTPLINKID,TABID,TABNAME,VCHFILENAME,INTPLINKID
        public int BUTTONID { get; set; }
        public string BUTTONNAME { get; set; }
        public string VCHFILENAME { get; set; }
        public int INTPLINKID { get; set; }
    ...
    public class ButtonTab
    {
        ...
        public List<ButtonMasterModel> ButtonList { get; set; }
        ...
        public string NVCHPROJECTLINKNAME { get; set; }
        public string NVCHGLINKNAME { get; set; }
        //public int BTNSORTMaxid { get; set; }
        //public int TABSORTMaxid { get; set; }
