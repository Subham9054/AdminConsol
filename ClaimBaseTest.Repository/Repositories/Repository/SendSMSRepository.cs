...
{
    public class SendSMSRepository : WizTestRepositoryBase, ISendSMSRepository
    {
        private readonly ILogger<SendSMSRepository> Logger;
        public SendSMSRepository(IWizTestConnectionFactory connectionFactory, ILogger<SendSMSRepository> logger) : base(connectionFactory)
        {
            Logger = logger;
