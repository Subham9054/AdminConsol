      ...
      public int ActiveFunction(FunctionMasterModel objFunctionMaster)
        {
            try
            {
                ...
                this.intOutput = Convert.ToInt32(SqlHelper.ExecuteNonQuery(DataBaseHelper.ConnectionString, "USP_CPKG_1_FUNCTION_MANAGE", out param, objArray));
            }
        ...
        public int AddFunction(FunctionMasterModel objFunctionMaster)
        {
            try
            {
                ...
                this.intOutput = SqlHelper.ExecuteNonQuery(DataBaseHelper.ConnectionString, "USP_CPKG_1_FUNCTION_MANAGE", out param, objArray);
            }
            catch (Exception exception)
            {
                throw new Exception("Execution Failed", exception);
        ...
        public IList<FunctionMasterModel> GetAllFunction(FunctionMasterModel objFunctionMaster)
        {
            ...
            DataSet ds = SqlHelper.ExecuteDataset(DataBaseHelper.ConnectionString, "USP_CPKG_1_FUNCTION_VIEW", objArray);
            if (ds.Tables.Count > 0)
            {
                DataTable dt = ds.Tables[0];
            }

            SqlDataReader reader = SqlHelper.ExecuteReader(DataBaseHelper.ConnectionString, "USP_CPKG_1_FUNCTION_VIEW", objArray);
            try
            {
        ...
        public string GetFunctionData(int intFuncId)
        {
            ...
            ds = SqlHelper.ExecuteDataset(DataBaseHelper.ConnectionString, "USP_CPKG_1_FUNCTION_VIEW", objArray);
            return ds.GetXml();
        }
        ...
        public IList<FunctionMasterModel> GetFunctionDetails(FunctionMasterModel objFunctionMaster)
        {
            ...
            IDataReader reader = (IDataReader)SqlHelper.ExecuteReader(DataBaseHelper.ConnectionString, "USP_CPKG_1_FUNCTION_VIEW", objArray);
